...
( function( $ ) {
    ...
    $( '.accordion-section[id*="_slider"]' ).live( 'expanded', function(){
        ...
        var $numberInput = $button.closest( '.customize-control' ).siblings( '#customize-control-sullivan_blog_slider_max_slides' ).find( 'input[type="number"]' ),
    ...
    $( '#button-add-slide' ).live( 'click', function(){
        ...
        // Number of slides input data
        var $numberInput = $( this ).closest( '.customize-control' ).siblings( '#customize-control-sullivan_blog_slider_max_slides' ).find( 'input[type="number"]' ),
            maxNumberVal = parseInt( $numberInput.attr( 'max' ) ),
            currentNumberVal = parseInt( $numberInput.val() ),
    ...
    $( '#accordion-section-sullivan_blog_slider' ).live( 'expanded', function(){
        var originalValue = wp.customize( 'sullivan_blog_slider_max_slides' ).get();
        handleSlider( 'blog', originalValue );
    } );


	// Slideshow blog: Hide controls depending on the number of slides
	wp.customize( 'sullivan_blog_slider_max_slides', function( value ) {
    ...
    $( '#accordion-section-sullivan_shop_slider' ).live( 'expanded', function(){
        var originalValue = wp.customize( 'sullivan_blog_slider_max_slides' ).get();
	...
	wp.customize( 'sullivan_shop_slider_max_slides', function( value ) {
    ...
    function handleSlider( slideshowArea, newval ){
        ...
        var $max_slidesControl = $( '#customize-control-sullivan_' + slideshowArea + '_slider_max_slides' ),
