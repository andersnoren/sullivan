...
class eames_contact_information extends WP_Widget {

	function __construct() {
        $widget_ops = array( 
			'classname'     => 'widget_eames_contact', 
			'description'   => __( 'Allows you to display contact information. Built with the "Footer #1" widget area in mind.', 'eames' ) 
		);
        parent::__construct( 'widget_eames_contact', __( 'Contact Information', 'eames' ), $widget_ops );
    }
	...
	function form( $instance ) {
        ...
        <p>
			<label for="<?php echo $this->get_field_id( 'widget_address' ); ?>"><?php  _e( 'Address', 'eames' ); ?>:
        ...
        <p>
			<label for="<?php echo $this->get_field_id( 'widget_phone' ); ?>"><?php  _e( 'Phone number', 'eames' ); ?>:
