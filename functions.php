...
if ( ! function_exists( 'sullivan_setup' ) ) :
	function sullivan_setup() {
		...
		// Register wide block alignment support.
		add_theme_support( 'align-wide' );

		// Register Block Editor color palette.
		...
		// Register Block Editor font sizes.
...
if ( ! function_exists( 'sullivan_add_editor_styles' ) ) :
	function sullivan_add_editor_styles() {
		...
		add_editor_style( array( 'assets/css/sullivan-classic-editor-style.css', 'assets/css/fonts.css' ) );
...
if ( ! function_exists( 'sullivan_enqueue_scripts' ) ) :
	function sullivan_enqueue_scripts() {
		...
		wp_register_script( 'flexslider', get_template_directory_uri() . '/assets/js/jquery.flexslider.min.js', '2.7.2', true );
		...
		// Localize query vars for the AJAX powered search.
...
if ( ! function_exists( 'sullivan_theme_activation_notice' ) ) :
...
if ( ! function_exists( 'sullivan_theme_activation_notice_output' ) ) :
...
if ( ! function_exists( 'sullivan_has_js' ) ) :
	function sullivan_has_js() {
		...
		echo "<script>jQuery( 'html' ).removeClass( 'no-js' ).addClass( 'js' );</script>";
...
if ( ! function_exists( 'sullivan_register_widgets' ) ) :
	function sullivan_register_widgets() {
		...
		// Unregister widgets replaced by custom ones.
...
if ( ! function_exists( 'sullivan_ajax_search' ) ) :
...
if ( ! class_exists( 'Sullivan_Walker_With_Sub_Toggles' ) ) : 
...
if ( ! class_exists( 'Sullivan_Customize' ) ) :
